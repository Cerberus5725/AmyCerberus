...
public class Kicker extends Subsystem {
    ...
    private final Servo kicker = RobotMap.kickerKicker;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
    public double forwardAngle = 150;
    public double resetAngle = 50;
    ...
    {
    kicker.setAngle(forwardAngle);
    }
    public void reset()
    {
    kicker.setAngle(resetAngle);
    }
